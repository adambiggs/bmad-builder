...
Use `references/brief-template.md` as a guide — adapt structure to fit the product's story.
...
1. **Skeptic Reviewer** (`skeptic-reviewer.md`) — "What's missing? What assumptions are untested? What could go wrong? Where is the brief vague or hand-wavy?"

2. **Opportunity Reviewer** (`opportunity-reviewer.md`) — "What adjacent value propositions are being missed? What market angles or partnerships could strengthen this? What's underemphasized?"
...
**Autonomous mode:** Skip to `finalize.md` — no user interaction. Save the improved draft directly.
